...
<body>
	...
	<main>
		<div class="section-nav">
			<button class="section-btn">ACTIVITIES</button>
			<button class="section-btn current">EVENTS</button>
		</div>
		...
		<section class="events">
			<article class="event-post">
				<img src="../media/article.png" alt="The event post's picture">
				<div class="event-details">
					<h2 class="event-title">Graduation Ceremony 2022 - 2023</h2>
					<p class="event-date">1st of January 2022 AT 5:30 pm</p>
					<p class="event-datePost">2 days ago</p>
					<div class="event-location">
						<iconify-icon icon="material-symbols:location-on-outline"></iconify-icon>
						<p class="event-loc">EMU CENTER</p>
					</div>
				</div>
			</article>
			<article class="event-post">
